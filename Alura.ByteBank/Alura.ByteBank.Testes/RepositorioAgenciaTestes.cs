...
{
    public class RepositorioAgenciaTestes
    {
        private readonly IAgenciaRepositorio _repositorio;

        public RepositorioAgenciaTestes()
        {
        ...
        public void TestaRemoverInformacaoDeterminadaAgencia()
        {
            ...
            _repositorio.Adicionar(agencia);

            int idUltimo = _repositorio.ObterTodos()[^1].Id;

            //Act
            var atualizado = _repositorio.Excluir(idUltimo);
